...
public class ConfigActivity extends PreferenceActivity implements OnPreferenceChangeListener {
    ...
    private static final String OBD_UPDATE_PERIOD_KEY = "obd_update_period_preference";
    public static final String VEHICLE_ID_KEY = "vehicle_id_preference";
    private static final String ENGINE_DISPLACEMENT_KEY = "engine_displacement_preference";
    private static final String VOLUMETRIC_EFFICIENCY_KEY = "volumetric_efficiency_preference";
    public static final String IMPERIAL_UNITS_KEY = "imperial_units_preference";
    private static final String COMMANDS_SCREEN_KEY = "obd_commands_screen";
    ...
    private static final String GPS_UPDATE_PERIOD_KEY = "gps_update_period_preference";
    private static final String GPS_DISTANCE_PERIOD_KEY = "gps_distance_period_preference";
    public static final String ENABLE_BT_KEY = "enable_bluetooth_preference";
    private static final String MAX_FUEL_ECON_KEY = "max_fuel_econ_preference";
    private static final String CONFIG_READER_KEY = "reader_config_preference";
    ...
    public static int getObdUpdatePeriod() {
        ...
        try {
            period = (int) (Double.parseDouble("2") * 1000);
        } catch (Exception e) {
        }
    ...
    /*
     * Get paired devices and populate preference mFaultslist.
     */
